...
post_manager = Project.create(image: "%PUBLIC_URL%/images/PostManager.jpg",
    name: "Post Manager",
...
natours = Project.create(image: "%PUBLIC_URL%/images/Natours.jpg",
    name: "Natours",
...
trillo = Project.create(image: "https://www.trionamoynihan.dev/static/media/Trillo.1f1deb4c.jpg",
    name: "Trillo",
...
nexter = Project.create(image: "%PUBLIC_URL%/images/Nexter.jpg",
    name: "Nexter",
...
fantasy_stocks = Project.create(image: "%PUBLIC_URL%/images/FantasyStocks.png",
    name: "Fantasy Stocks",
