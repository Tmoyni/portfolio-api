...
portfolio = Project.create(image: "https://i.imgur.com/anOe2w9.png",
...
post_manager = Project.create(image: "https://i.imgur.com/mN4Bux2.jpg",
    name: "Post Manager",
...
natours = Project.create(image: "https://i.imgur.com/TZ5Eo5u.png",
    name: "Natours",
...
fem_fylo = Project.create(image: "https://i.imgur.com/8F15HOv.png",
    name: "Fylo Data Storage Component",
    details: "This project came from a Front End Mentor challenge (https://www.frontendmentor.io). The desktop and mobile designs and assets were supplied and I built the component using HTML, CSS and Sass to be responsive per the design specifications. It is deployed using GitHub Pages.",
    tech: "HTML, CSS, SASS, Flexbox, GitHub Pages",
    url: "https://tmoyni.github.io/fylo-data-storage-component/",
    github: "https://github.com/Tmoyni/fylo-data-storage-component"),
fem_article_preview = Project.create(image: "https://i.imgur.com/RxZPaLe.png",
    name: "Article Preview Component",
    details: "Another project Front End Mentor challenge (https://www.frontendmentor.io). Again the desktop and mobile designs and assets were supplied and I built the responsive component using HTML, CSS and Javascript. It is deployed using GitHub Pages.",
    tech: "HTML, CSS, Javascript, Flexbox, GitHub Pages",
    url: "https://tmoyni.github.io/article-preview-component/",
    github: "https://github.com/Tmoyni/article-preview-component"),
trillo = Project.create(image: "https://i.imgur.com/CwywAyo.png",
    name: "Trillo",
...
nexter = Project.create(image: "https://i.imgur.com/vFaBFGa.png",
    name: "Nexter",
...
fantasy_stocks = Project.create(image: "https://i.imgur.com/e9vtOPb.png",
    name: "Fantasy Stocks",
